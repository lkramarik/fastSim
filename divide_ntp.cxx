...
//        if ((pi1_pt>0.15) && (k_pt>0.15) && (cosTheta>0.5) && (pi1_dca>0.001) && (k_dca>0.001) && (D_pt>0.5) && (D_pt<6)){
               //             cout<<i<<endl;
                //            cout<<D_mass<<endl;
                //        ntpOut->Fill(D_mass, D_decayL, D_theta, D_cosThetaStar, cosTheta, D_pt, pi1_pt, k_pt, pi1_dca, k_dca, dcaDaughters, dcaD0ToPv, kTOF, pTOF, kHft, pHft, pTpc, kTpc);
		arr[]=D_mass;
                ntpOut->Fill(D_mass, D_decayL, D_cosThetaStar, cosTheta, D_pt, D_ptSIM, pi1_pt, k_pt, pi1_dca, k_dca, dcaDaughters, dcaD0ToPv, hft, pid, etas, tpc);
